    ...
    public class FTPHelper
    {
        ...
        public static bool FtpDownload(string remoteFileName, string localFileName, bool ifCredential, Action<int, int> updateProgress = null)
        {
            ...
            try
            {
                ...
                ftpsize = (FtpWebRequest)WebRequest.Create(uri);
        ...
        public static bool FtpUploadBroken(string localFullPath, string remoteFilepath, Action<int, int> updateProgress = null)
        {
            ...
            {
                uri = Path.Combine(ftpURI, newFileName);
            }
            else
            {
                uri = Path.Combine(ftpURI, remoteFilepath, newFileName);
        ...
        private static string RemoveSpaces(string str)
        {
            ...
            string sdate = DateTime.Now.Year.ToString() + DateTime.Now.Month.ToString() + DateTime.Now.Day.ToString() + DateTime.Now.Hour.ToString()
        ...
        public static void MakeDir(string dirName)
        {
            ...
            try
            {
                ...
                reqFTP = (FtpWebRequest)WebRequest.Create(new Uri(Path.Combine(ftpURI, dirName)));
