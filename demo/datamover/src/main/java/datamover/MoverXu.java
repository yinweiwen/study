...
public class MoverXu {
    ...
    public static void main(String[] args) {
        ...
        long hours = (new DateTime(2019, 1, 25, 0, 0).getMillis() -
                new DateTime(2018, 8, 1, 0, 0).getMillis()) / (60 * 60 * 1000);
        ...
        // 青山桥倾斜CX3：31、CX2：28
        DateTime dt1 = new DateTime(2019, 1, 25, 0, 40);
        DateTime dt2 = new DateTime(2019, 1, 31, 13, 00);
        int hourDelay = 4248;
        ...
        // 路长乡政府734
        dt1 = new DateTime(2019, 01, 22, 0, 30);
        dt2 = new DateTime(2019, 01, 31, 13, 0);
        es.migrateThemeData(734, 693, 202, dt1, dt2, 0);
        es.migrateThemeData(734, 689, 200, dt1, dt2, 0);
